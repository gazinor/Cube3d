...
/*   Updated: 2020/02/19 03:26:31 by glaurent         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "cub3d.h"
...
*/	data->ray.f_texx = (int)(((double)(data->perso.pos.x + (double)data->ray.cur_dist[y] * data->ray.dirx)
	- (int)((double)(data->perso.pos.x + (double)data->ray.cur_dist[y] * data->ray.dirx))) * data->sol.width);
	data->ray.f_texy = (int)(((double)(data->perso.pos.y + (double)data->ray.cur_dist[y] * data->ray.diry)
	- (int)((double)(data->perso.pos.y + (double)data->ray.cur_dist[y] * data->ray.diry))) * data->sol.height);
...
*/	data->ray.f_texx = (int)(((double)(data->perso.pos.x + (double)data->ray.cur_dist[y] * data->ray.dirx)
	- (int)((double)(data->perso.pos.x + (double)data->ray.cur_dist[y] * data->ray.dirx))) * data->plafond.width);
	data->ray.f_texy = (int)(((double)(data->perso.pos.y + (double)data->ray.cur_dist[y] * data->ray.diry)
	- (int)((double)(data->perso.pos.y + (double)data->ray.cur_dist[y] * data->ray.diry))) * data->plafond.height);
	data->img.buffer[x + (y * (data->img.width))] =
